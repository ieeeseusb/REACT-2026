      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 mb-12">
            <a
              href="#segments"
              className="w-full sm:w-auto px-8 py-4 bg-[#FF7700] hover:bg-black text-white font-black text-sm sm:text-base uppercase tracking-widest rounded-xl transition-all flex items-center justify-center gap-2.5 shadow-lg hover:shadow-xl hover:-translate-y-0.5 cursor-pointer"
            >
